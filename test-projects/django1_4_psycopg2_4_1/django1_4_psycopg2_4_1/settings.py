# Django settings for django1_4 project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'slumber-test',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '(6!-+utrzox_4$5^flfcbc%!qigo6!%2n&amp;$_#$f^fd9s4xl4k-'
...
ROOT_URLCONF = 'django1_4_psycopg2_4_1.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'django1_4_psycopg2_4_1.wsgi.application'
